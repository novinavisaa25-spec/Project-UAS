        ...
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control @error('nama') is-invalid @enderror" 
                           id="nama" name="nama" value="{{ old('nama') }}" placeholder="Contoh: John Doe">
                    @error('nama')
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control @error('no_ktp') is-invalid @enderror" 
                           id="no_ktp" name="no_ktp" value="{{ old('no_ktp') }}" placeholder="16 digit">
                    @error('no_ktp')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control @error('no_sim') is-invalid @enderror" 
                           id="no_sim" name="no_sim" value="{{ old('no_sim') }}" placeholder="Contoh: SIM12345">
                    @error('no_sim')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select id="tipe_sim" name="tipe_sim" class="form-control @error('tipe_sim') is-invalid @enderror">
                        ...
                        <option value="A" {{ old('tipe_sim') == 'A' ? 'selected' : '' }}>A</option>
                        <option value="B1" {{ old('tipe_sim') == 'B1' ? 'selected' : '' }}>B1</option>
                        <option value="B2" {{ old('tipe_sim') == 'B2' ? 'selected' : '' }}>B2</option>
                        <option value="C" {{ old('tipe_sim') == 'C' ? 'selected' : '' }}>C</option>
                    </select>
                    @error('tipe_sim')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control @error('telepon') is-invalid @enderror" 
                           id="telepon" name="telepon" value="{{ old('telepon') }}" placeholder="Contoh: 08123456789">
                    @error('telepon')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="date" class="form-control @error('tanggal_gabung') is-invalid @enderror" id="tanggal_gabung" name="tanggal_gabung" value="{{ old('tanggal_gabung') }}">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select id="status_aktif" name="status_aktif" class="form-control @error('status_aktif') is-invalid @enderror">
                        ...
                        <option value="tidak_aktif" {{ old('status_aktif') == 'tidak_aktif' ? 'selected' : '' }}>Tidak Aktif</option>
